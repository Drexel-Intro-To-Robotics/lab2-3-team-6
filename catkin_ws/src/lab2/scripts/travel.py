...
class PathFollower:
    ...
    def odom_callback(self, msg):
        #Updates the live position and heading
        self.current_x = msg.pose.pose.position.x
        self.current_y = msg.pose.pose.position.y

        # Convert quaternion to simple 2D yaw angle (radians)
    ...
    def execute_path(self):
        ...
        for index, waypoint in enumerate(self.waypoints):
            ...
            while not rospy.is_shutdown():
                ...
                # Normalize angle error to keep between -pi and +pi
                angle_error = math.atan2(math.sin(angle_error), math.cos(angle_error))

                # Check if successfully arrived at this waypoint
                ...
                # Prioritize turning to face the target first
        ...
        # Stop the robot entirely at goal
        stop_cmd = Twist()
